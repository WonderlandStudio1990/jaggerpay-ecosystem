...
const bills = [
  {
    id: 'BILL-001',
    vendor: 'Studio Equipment Co.',
    amount: 2500.00,
    dueDate: '2024-03-15',
    status: 'pending',
    category: 'Equipment',
    description: 'Recording equipment rental',
  },
  {
    id: 'BILL-002',
    vendor: 'Venue Services LLC',
    amount: 5000.00,
    dueDate: '2024-03-20',
    status: 'paid',
    category: 'Venue',
    description: 'Event venue booking for March',
  },
  {
    id: 'BILL-003',
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white shadow-sm rounded-lg divide-y divide-gray-200">
          {filteredBills.map((bill) => (
            <Link
              key={bill.id}
              href={`/dashboard/bill-pay/${bill.id}`}
